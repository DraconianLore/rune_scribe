...
Rune.create(
    ...
    description: %(While active the creature is under the effect of the Phantasmal Force spell),
    additional: %(Phantasmal Force: 
